...
const Sidebar = () => {
    ...
    return (
        <aside className='h-[500px]   w-20 lg:w-72 border-r border-base-300 flex flex-col transition-all duration-200'>
            ...
            <div className='overflow-y-auto scrollbar-hide scrollbar-thumb-zinc-400 scrollbar-track-transparent
 w-full py-3'>
